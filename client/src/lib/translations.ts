...
const translations: Record<Language, Translations> = {
  ko: {
    ...
    // Enhanced Explore
    'explore.source': '소스',
    'explore.sourceCurated': '큐레이션 프롬프트',
    'explore.sourceLexica': 'Lexica',
    'explore.sourceCivitai': 'Civitai',
    'explore.category': '카테고리',
    'explore.categoryAll': '전체',
    'explore.categoryFantasy': '판타지',
    'explore.categoryPortrait': '인물',
    'explore.categoryLandscape': '풍경',
    'explore.categoryScifi': 'SF',
    'explore.categoryAnime': '애니메이션',
    'explore.categoryArchitecture': '건축',
    'explore.categoryAbstract': '추상',
    'explore.categoryProduct': '제품',
    'explore.categoryCharacter': '캐릭터',
    'explore.categoryNature': '자연',
    'explore.showRandom': '랜덤 프롬프트',
    'explore.suggestedParams': '추천 파라미터',
    'explore.applySettings': '설정 적용',
    'explore.curatedDesc': '전문적으로 큐레이션된 미드저니 프롬프트 예제',
    'explore.lexicaDesc': 'Lexica.art에서 AI 아트 프롬프트 검색',
    'explore.civitaiDesc': 'Civitai 커뮤니티에서 프롬프트 검색',
    'explore.totalPrompts': '개의 프롬프트',
    'explore.useCurated': '프롬프트 사용',
  },
  en: {
    // Header
    ...
    'explore.sourceCurated': 'Curated Prompts',
    'explore.sourceLexica': 'Lexica',
    'explore.sourceCivitai': 'Civitai',
    'explore.category': 'Category',
    'explore.categoryAll': 'All',
    'explore.categoryFantasy': 'Fantasy',
    'explore.categoryPortrait': 'Portrait',
    'explore.categoryLandscape': 'Landscape',
    'explore.categoryScifi': 'Sci-Fi',
    'explore.categoryAnime': 'Anime',
    'explore.categoryArchitecture': 'Architecture',
    'explore.categoryAbstract': 'Abstract',
    'explore.categoryProduct': 'Product',
    'explore.categoryCharacter': 'Character',
    'explore.categoryNature': 'Nature',
    'explore.showRandom': 'Random Prompts',
    'explore.suggestedParams': 'Suggested Parameters',
    'explore.applySettings': 'Apply Settings',
    'explore.curatedDesc': 'Professionally curated Midjourney prompt examples',
    'explore.lexicaDesc': 'Search AI art prompts from Lexica.art',
    'explore.civitaiDesc': 'Search prompts from Civitai community',
    'explore.totalPrompts': 'prompts',
    'explore.useCurated': 'Use Prompt',
  }
};
